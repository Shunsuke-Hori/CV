...
\urlstyle{same}
\newcolumntype{H}{>{\raggedright\hangindent=1.5em\hangafter=1\arraybackslash}X}
\newcolumntype{Y}{>{\raggedright\arraybackslash}X}
\newcolumntype{Z}{>{\raggedleft\arraybackslash}X}
\newcolumntype{R}{>{\raggedleft\arraybackslash}p{0.95in}}
\newcolumntype{D}{>{\raggedleft\arraybackslash}l}
...
Email: \href{mailto:shunsuke.hori@keio.jp}{shunsuke.hori@keio.jp}\\
Website: \url{https://shunsuke-hori.pages.dev}\\
Phone: (+81) 03-5427-1574

\section*{FIELDS OF INTEREST}
Macroeconomics, Macro Labor, Macro Finance
...
\begin{tabularx}{\linewidth}{@{}l Y R@{}}
Assistant Professor &Faculty of Economics, Keio University& 2026--present\\
\end{tabularx}

\section*{PREVIOUS POSITIONS}
\begin{tabularx}{\linewidth}{@{}l Y R@{}}
Assistant Professor &Faculty of Economics, Hitotsubashi University& 2023--2026\\
\end{tabularx}

\section*{OTHER RELEVANT POSITIONS HELD}
\begin{tabularx}{\linewidth}{@{}l Y R@{}}
Project Researcher &University of Tokyo& 2023--2026\\
...
\begin{tabularx}{\linewidth}{@{}H Y R@{}}
Grant-in-aid for Studies on Economics and Finance & Zengin Foundation & 2026--2028 \\
Joint Usage / Research Center&Institute of Economic Research, Hitotsubashi University&2025\\
Koueki Shintaku Yamada Gakujutsu Kenkyu Shourei Kikin&Mitsubishi UFJ Trust and Banking&2024--2026\\
Grant-in-Aid for Early-Career Scientists&Japan Society for the Promotion of Science&2024--2028\\
Walter P. Heller Memorial Prize&University of California, San Diego&2020\\
Summer 2019 GSA Travel Grant&University of California, San Diego&2019\\
Graduate Student Research Funding&University of California, San Diego&2019\\
Japan-IMF Scholarship&Japan IMF Scholarship Program for Advanced Studies&2017--2019
\end{tabularx}

\section*{PUBLISHED PAPERS}
\paperentry{``Quarantine policy and labor market outcomes'' (with Asako Chiba and Taisuke Nakata), \textit{Macroeconomic Dynamics}, 30, e39, 2026. \href{https://doi.org/10.1017/S1365100526101102}{doi:10.1017/S1365100526101102}}
...
\paperentry{``The Secular Decline in Aggregate Hours Worked in Japan: A Reinterpretation''}
% \begin{adjustwidth}{1em}{1em}
...
% \end{adjustwidth}
% \vspace{1em}
\paperentry{``A Macroeconomic Model with Rational Exuberance: Temporarily Explosive Land Price Dynamics'' (with Tomohiro Hirano and Shuping Shi)}
% \begin{adjustwidth}{1em}{1em}
...
% \end{adjustwidth}
% \vspace{1em}
\paperentry{``COVID-19 Infection and Its Labor Supply Impact: Evidence from a Large-scale Survey in Japan'' (with Asako Chiba, Taisuke Nakata, Shusaku Sasaki, Reo Takaku)}
% \begin{adjustwidth}{1em}{1em}
...
% \end{adjustwidth}
% \vspace{1em}
\paperentry{``Generational war on inflation: Optimal inflation rates for the young and the old'' (with Ippei Fujiwara and Yuichiro Waki)}
% \begin{adjustwidth}{1em}{1em}
...
\paperentry{``The Japanese Land Price Boom as an Expectation-Driven Rational Bubble'' (with Ryo Jinnai)}
\paperentry{``Human capital and Technology Diffusion: Expanding the Discussion of Industrial Policy'' (with Alexis Meyer Cirkel)}
\paperentry{``Hysteresis in Hours Worked''}

% \section*{OTHER PROJECTS}

\section*{TEACHING EXPERIENCE}
\subsubsection*{At Keio University}
\begin{tabularx}{\linewidth}{@{}l Z@{}}
Money, Banking, and Finance A & Spring \& Summer 2026\\
\end{tabularx}
